            ...
            <div className="fixed left-0 top-1/2 -translate-y-1/2 z-50 hidden md:flex flex-col gap-2">
                ...
                <Dialog open={isOpen} onOpenChange={setIsOpen}>
                    <DialogTrigger asChild>
                        <button className="bg-[#005EED] hover:bg-[#004dc2] text-white flex flex-col items-center justify-center p-2 rounded-r-xl shadow-lg transition-transform transform hover:translate-x-1 border border-[#005EED]">
                            <div
                ...
                <a
                    ...
                    className="bg-[#25D366] hover:bg-[#20bd5a] text-white w-[48px] h-[48px] flex items-center justify-center rounded-r-xl shadow-lg transition-transform transform hover:translate-x-1"
                    style={{
