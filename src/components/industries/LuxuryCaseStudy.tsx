        ...
        <section ref={containerRef} className="relative bg-white py-24 md:py-32 overflow-hidden border-b border-slate-200">
            <div className="container-tight relative z-10">
                ...
                <div className="max-w-3xl mx-auto relative">
                    ...
                    <div className="absolute start-6 md:start-8 top-8 bottom-8 w-px bg-slate-200" />

                    <div className="space-y-12 relative z-10">
                        {/* Step 1 */}
                        <div className="case-element relative ps-20 md:ps-24">
                            <div className="absolute start-0 h-14 w-14 rounded-2xl bg-slate-50 border border-slate-200 flex items-center justify-center text-brand-blue font-black text-xl shadow-sm">
                                01
                            </div>
                        ...
                        {/* Step 2 */}
                        <div className="case-element relative ps-20 md:ps-24">
                            <div className="absolute start-0 h-14 w-14 rounded-2xl bg-brand-blue/5 border border-brand-blue/20 flex items-center justify-center text-brand-blue font-black text-xl shadow-sm">
                                02
                            </div>
                            <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
                        ...
                        {/* Step 3 */}
                        <div className="case-element relative ps-20 md:ps-24">
                            <div className="absolute start-0 h-14 w-14 rounded-2xl bg-emerald-50 border border-emerald-200 flex items-center justify-center text-emerald-600 font-black text-xl shadow-sm">
                                03
                            </div>
                            <div className="bg-white rounded-2xl border border-emerald-100 bg-emerald-50/30 p-8 shadow-sm">
                                ...
                                <div className="flex items-baseline gap-1 mt-auto">
                                    ...
                                    <div className="text-xs font-bold uppercase tracking-widest text-slate-500 ms-3">Efficiency Gain</div>
                                </div>
                            </div>
                        </div>
                    </div>
