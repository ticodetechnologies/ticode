    ...
    <>
      ...
      <section className="section-padding">
        <div className="container-tight">
          <motion.div initial="hidden" animate="visible" variants={fadeIn} className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="text-3xl font-bold text-foreground sm:text-4xl lg:text-5xl">{t('pages.caseStudies.headline')}</h1>
      ...
      <section className="section-padding bg-card/50">
        <div className="container-tight space-y-8">
          {studies.map((s, i) => (
            <motion.div key={i} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeIn} className="rounded-xl border border-border bg-card p-6 sm:p-8">
      ...
      <section className="section-padding gradient-navy">
        <div className="container-tight text-center">
          <h2 className="text-2xl font-bold text-foreground sm:text-3xl">{t('pages.caseStudies.ctaTitle')}</h2>
